...
INSERT INTO vehicle_coordinates(track_id, vehicle_id, lat, lon, position, visited)
values (100019, 100005, 33.957080, -118.373588, st_setsrid(st_makepoint(-118.373588, 33.957080), 4326),  '2008-01-01 17:00');
INSERT INTO vehicle_coordinates(track_id, vehicle_id, lat, lon, position, visited)
values (100019, 100005, 34.050818, -118.046074, st_setsrid(st_makepoint(-118.046074, 34.050818), 4326),  '2008-01-01 19:00');
INSERT INTO vehicle_coordinates(track_id, vehicle_id, lat, lon, position, visited)
values (100019, 100005, 33.853718, -118.070983, st_setsrid(st_makepoint(-118.0709837, 33.853718), 4326),  '2008-01-01 21:00');
INSERT INTO vehicle_coordinates(track_id, vehicle_id, lat, lon, position, visited)
values (100019, 100005, 34.097753, -118.354832, st_setsrid(st_makepoint(-118.354832, 34.097753), 4326),  '2008-01-01 23:00');
